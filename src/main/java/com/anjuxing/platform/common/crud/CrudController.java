...
public class CrudController<S extends CrudService<T>, T extends CrudModel<T>> extends BaseController {
	 ...
	 */
	@GetMapping(value = "/{id}")
	public JsonResult get(@PathVariable String id) throws ControllerException {
	...
	public JsonResult getIds(@RequestBody List<String> ids) throws ControllerException {
	 ...
	 */
	@PutMapping(value="/{id}")
	public JsonResult update(@PathVariable String id, @RequestBody T model) throws ControllerException {
		JsonResult jsonResult = getJsonResult();
	...
	public JsonResult remove(@PathVariable String id) throws ControllerException {
	...
	public JsonResult cancel(@RequestBody List<String> ids) throws ControllerException {
		JsonResult jsonResult = getJsonResult();
	...
	public JsonResult remove(@RequestBody List<String> ids) throws ControllerException {
		JsonResult jsonResult = getJsonResult();
		if (ids != null && ids.size() > 0) {
